...
class UnicornSimpleHeap(object):
    ...
    HEAP_MIN_ADDR = 0x1A000 # 0x00001000 # # WARNING: check where the heap really starts
    HEAP_MAX_ADDR = 0x3C000 # 0xFFFFFFFF
...
class AflUnicornEngine(Uc):
    ...
    def __map_segments(self, segment_list, context_directory, debug_print=True):
